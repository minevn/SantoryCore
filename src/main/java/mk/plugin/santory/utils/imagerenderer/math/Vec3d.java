...
package mk.plugin.santory.utils.imagerenderer.math;
...
public class Vec3d {
    ...
    /**
     * Converts the given {@link Location} coordinates into a {@link Vec3d}.
     * @param location The {@link Location} to be converted.
     * @return The {@link Vec3d} with the coordinates of the given parameter.
     */
    ...
    /**
     * Converts the given {@link Vector} coordinates into a {@link Vec3d}.
    ...
    /**
     * @param vec The other {@link Vec3d} to be calculated with.
