...
public interface Renderer {
    ...
    void render(Player player, float redstoneSize);
     ...
     */
    default void render(Collection<? extends Player> players, float redstoneSize) {
        players.forEach(p -> this.render(p, redstoneSize));
    }
