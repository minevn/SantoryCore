...
package mk.plugin.santory.utils.imagerenderer.particle;
...
public class ImageRenderer implements Renderer {
     ...
     */
    @Override
    public void render(Player player, float redstoneSize) {
        ...
        for (int x = 0; x < image.getWidth(); x++) {
            for (int y = 0; y < image.getHeight(); y++) {
                ...
                renderer.setParticleParam(new ParticleParamRedstone(color.getRed() / 255f, color.getGreen() / 255f, color.getBlue() / 255f, redstoneSize));
                renderer.render(player, redstoneSize);
